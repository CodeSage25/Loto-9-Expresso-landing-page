...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "Oui, absolument. IziLoto.cm est une plateforme de jeux en ligne, en conformité avec la réglementation camerounaise en vigueur. La plateforme est sécurisée et les transactions sont protégées. Nous promouvons le jeu responsable et interdisons l'accès aux mineurs de moins de 21 ans.",
  },
];
